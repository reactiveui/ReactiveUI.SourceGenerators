...
public partial class ViewModelControlHostGenerator
{
    ...
    {
        internal static CompilationUnitSyntax GetViewModelControlHost(ViewModelControlHostInfo iViewForInfo)
        {
                            ...
                            .WithBaseList(
                                BaseList(
                                    SeparatedList<BaseTypeSyntax>(
                                        ...
                                        {
                                SimpleBaseType(IdentifierName(iViewForInfo.ViewModelTypeName)),
            ...
            var body = """
                ...
                """.Replace("####REPLACEME####", iViewForInfo.ClassName);
